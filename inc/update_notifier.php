...
?>
    ...
    <div class="wrap">
        ...
        <p style="font-size:16px;">【 <a href="https://dl.tcd-theme.com/tcd051/vogue/vogue_tcd051.zip"><?php _e( 'Download the latest version', 'tcd-w' ); ?></a> 】</p>
     		<div id="mono_info">
...
function get_latest_theme_version( $interval ) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_vogue.xml';
	$db_cache_field = 'vogue-contempo-notifier-cache';
	$db_cache_field_last_updated = 'vogue-contempo-notifier-last-updated';
