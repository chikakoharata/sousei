...
add_page_builder_widget(array(
	...
	'additional_class' => 'pb-repeater-widget pb-widget-has-editor',
	'priority' => 21
));
...
<div class="form-field">
	...
	<table style="margin-top:5px;">
		...
		<tr>
			...
			<td><input type="number" name="pagebuilder[widget][<?php echo esc_attr($values['widget_index']); ?>][arrow_opacity]" value="<?php echo esc_attr($values['arrow_opacity']); ?>" class="small-text" min="0" max="1" step="0.1" /> px</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="number" name="pagebuilder[widget][<?php echo esc_attr($values['widget_index']); ?>][arrow_opacity_hover]" value="<?php echo esc_attr($values['arrow_opacity_hover']); ?>" class="small-text" min="0" max="1" step="0.1" /> px</td>
		</tr>
	</table>
</div>
